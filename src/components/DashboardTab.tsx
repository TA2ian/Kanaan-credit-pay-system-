    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <button 
              ...
              title="الانتقال إلى قسم العملاء"
              className="w-12 h-12 rounded-xl bg-white shadow-2xs border border-indigo-50 flex items-center justify-center text-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 active:scale-90 transition-all duration-200 z-10 cursor-pointer"
            >
          ...
          <motion.div 
            ...
            whileHover={{ y: -3, transition: { duration: 0.12 } }}
            style={{ willChange: 'transform, opacity' }}
            className={`p-5 rounded-2xl border shadow-2xs hover:shadow-xs flex items-center justify-between transition-shadow duration-200 relative overflow-hidden group ${
          ...
          >
            <div className="space-y-2 z-10">
              ...
              {summary.overdueCount > 0 ? (
                <span className="inline-block text-[8px] font-bold text-amber-700 bg-amber-100/60 rounded-full px-2 py-0.5">
                  يتطلب إرسال إشعار
                </span>
              ) : (
                <span className="inline-block text-[8px] font-bold text-emerald-600 bg-emerald-50 rounded-full px-2 py-0.5">
                  الوضع مستقر ومثالي
                </span>
              )}
            </div>
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-2xs transition-transform duration-200 group-hover:scale-105 z-10 ${
              summary.overdueCount > 0 
      ...
      {overdueBalances.length > 0 && (
        <motion.div 
          ...
          className="p-5 bg-amber-50 rounded-2xl border border-amber-200/60 text-amber-850 flex items-start gap-3.5"
        >
          ...
          <div className="text-xs space-y-3 text-right w-full" dir="rtl">
            ...
            <div className="space-y-1.5 bg-white/70 p-3 rounded-xl border border-amber-200/30">
              ...
              <div className="flex flex-wrap gap-2">
                {overdueBalances.map((b) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] bg-white/65 px-1 py-0.5 rounded text-amber-800 font-semibold">{formatCurrency(b.remainingDebt)}</span>
                  </button>
                ))}
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-6 bg-white rounded-2xl border border-slate-100 shadow-xs flex flex-col justify-between space-y-4">
          ...
          <div className="grid grid-cols-3 gap-1.5 text-center text-[10px] font-bold">
            ...
            >
              <span className="text-emerald-700 block">مسددين</span>
            ...
            >
              <span className="text-indigo-700 block">ملتزمين</span>
            ...
            >
              <span className="text-amber-700 block">متأخرين</span>
