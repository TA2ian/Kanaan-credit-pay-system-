    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal Container */}
          <motion.div 
            className="bg-white rounded-[28px] w-full max-w-lg shadow-2xl relative z-10 overflow-hidden border border-slate-100 transition-colors" 
            dir="rtl"
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50 transition-colors">
